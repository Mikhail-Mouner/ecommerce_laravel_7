...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/front/main.css') }}" type="text/css" media="all">
...
<body id="index" class="lang-ar lang-rtl country-gb currency-gbp layout-full-width page-index tax-display-enabled">
    <main id="main-site" class="displayhomenovthree">
        <header id="header" class="header-3 sticky-menu">
            ...
            @include('layouts.includes.front.header-mobile')
            {{--include header-top--}}
            @include('layouts.includes.front.header-top')
            {{--include header-center--}}
            @include('layouts.includes.front.header-center')
            {{--include header-bottom--}}
            @include('layouts.includes.front.header-bottom')
        </header>
